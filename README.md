...
```
ghcr.io/hanthor/ubuntu-26.04-server-bootc:latest
```
...
└── ghcr.io/hanthor/ubuntu-26.04-bootc
    ├── ghcr.io/hanthor/ubuntu-26.04-server-bootc   ← you are here
...
| **[ubuntu-26.04-server-bootc](https://github.com/hanthor/ubuntu-26.04-server-bootc)** | This image — server layer on top of the base |
...
- [composefs verity regression on kernel 7.0](https://github.com/hanthor/ubuntu-26.04-desktop-bootc/issues/2)
- [sysroot.mount / systemd-gpt-auto-generator quirk](https://github.com/hanthor/ubuntu-26.04-desktop-bootc/issues/3)
